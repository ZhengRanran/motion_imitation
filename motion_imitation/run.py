...
def main():
    ...
    arg_parser.add_argument("--motion_file", dest="motion_file", type=str, default="data/motions/dog_pace.txt")
    ...
    model = build_model(
        env=env, num_procs=num_procs,
        timesteps_per_actorbatch=TIMESTEPS_PER_ACTORBATCH,
        optim_batchsize=OPTIM_BATCHSIZE, output_dir=args.output_dir)
